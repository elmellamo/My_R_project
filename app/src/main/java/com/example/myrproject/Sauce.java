...
public class Sauce extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] textSet = {"설탕","소금","후추","새우젓","고추장", "고추가루","간장","된장","케찹","식용유","연유","마요네즈","스테이크소스","굴소스","파스타소스","칠리소스","식초","메이플시럽","초콜릿시럽"};
        int[] imgSet = {R.drawable.sugar, R.drawable.salt,R.drawable.pepper,R.drawable.shrimp22,R.drawable.chillipepper, R.drawable.chilipowder2,R.drawable.soysauce, R.drawable.soybeanpaste, R.drawable.ketchup
